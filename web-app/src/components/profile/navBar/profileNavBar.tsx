                        ...
                        <Row className='d-flex flex-row align-content-center'>
                            <Col>
                                {isMobile && <Button className='ms-0 me-1 p-1' variant='outline-light'
                                                     style={{fontSize: "30px", color: "#82807c"}} onClick={handleToggleSidebar}><FiMenu/></Button>
                                }
                                <Navbar.Brand onClick={() => navigate('/')} style={{cursor: "pointer"}}>
                                    <img src={Images.logo} style={{maxWidth: "240px"}} alt='logo' className='profile-nav-logo'/>
                                </Navbar.Brand>
                            </Col>
                        </Row>
                        <Navbar.Toggle aria-controls="responsive-navbar-nav" className='ms-2'
                                       style={{fontSize: "30px", color: "#82807c", float:"right"}}><FaRegUserCircle/></Navbar.Toggle>

                    </Col>
                    <Col lg={10}>
                        <Navbar.Collapse id="responsive-navbar-nav">
                            <Nav className='ps-md-4 ms-auto d-flex flex-lg-row flex-column align-items-end align-items-end'>
                                <Nav.Link>
