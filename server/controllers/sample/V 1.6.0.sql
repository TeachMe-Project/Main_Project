...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2022 at 08:43 AM
...
INSERT INTO `course` (`course_id`, `teacher_id`, `course_name`, `grade`, `subject`, `description`, `duration`, `start_date`, `start_time`, `end_time`, `day`, `medium`, `price`, `isActive`, `created_date`) VALUES
(3, 2, 'Science for AL', '12', 'Science', 'for AL', 2, '2022-07-27', '18:30:00', '21:30:00', 'WED', 'Sinhala', 2000, 1, 'Wed, 10 Aug 2022 00:00:00 GMT'),
(4, 3, 'Maths for OL', '10', 'Maths', 'Maths for OL exam', 2, '2022-07-04', '16:00:00', '18:00:00', 'FRI', 'Sinhala', 3000, 1, 'Mon, 18 Jul 2022 00:00:00 GMT'),
(23, 1000010224, 'Maths', '10', 'Maths', 'dasdas', 2, '2022-08-23', '15:30:57', '18:30:57', 'SUN', 'Sinhala', 2000, 1, 'Tue, 06 Sep 2022 00:00:00 GMT'),
(100, 1000010223, 'Grade 10 Science', '10', 'Science', 'Good', 2, '2022-08-24', '15:30:28', '17:30:28', 'SUN', 'Sinhala', 2500, 1, 'Wed, 07 Sep 2022 00:00:00 GMT');
...
INSERT INTO `homework` (`homework_id`, `course_id`, `uploaded_date`, `homework`, `isActive`) VALUES
(1, 3, '2022-07-26 00:00:00', 'http://localhost/phpmyadmin/index.php?route=/table/change&db=groupproject2&table=parent_payment', 1),
(2, 4, '2022-07-26 00:00:00', 'http://localhost/phpmyadmin/index.php?route=/table/change&db=groupproject2&table=parent_payment', 1);
...
INSERT INTO `notes` (`note_id`, `uploaded_date`, `note`, `course_id`, `isActive`) VALUES
(1, '2022-07-26 00:00:00', 'http://localhost/phpmyadmin/index.php?route=/table/change&db=groupproject2&table=parent_payment', 3, 1),
(2, '2022-07-26 00:00:00', 'http://localhost/phpmyadmin/index.php?route=/table/change&db=groupproject2&table=parent_payment', 4, 1);
...
CREATE TABLE `student_class` (
  ...
  `end_time` varchar(100) NOT NULL DEFAULT current_timestamp(),
  `status` enum('upcoming','ended','cancelled') NOT NULL DEFAULT 'upcoming',
  `joined_time` varchar(100) NOT NULL DEFAULT current_timestamp(),
  `left_time` varchar(100) NOT NULL DEFAULT current_timestamp(),
...
INSERT INTO `student_class` (`class_id`, `course_id`, `student_id`, `date`, `start_time`, `end_time`, `status`, `joined_time`, `left_time`, `online_status`, `isActive`, `isStarted`) VALUES
(3, 4, 1, '2022-08-02 18:30:00', '2022-07-26 17:10:04', '2022-07-26 17:10:04', 'upcoming', '2022-07-26 17:10:04', '2022-07-26 17:10:04', 'online', 1, 0),
(4, 3, 2, '2022-07-31 18:30:00', '2022-07-26 17:10:04', '2022-07-26 17:10:04', 'upcoming', '2022-07-26 17:10:04', '2022-07-26 17:10:04', 'online', 1, 0),
(5, 3, 1, '2022-08-02 18:30:00', '8:00:00 PM', '9:30:00 PM', 'upcoming', '2022-08-24 00:42:24', '2022-08-24 00:42:24', 'online', 1, 0);
...
INSERT INTO `teacher` (`user_id`, `teacher_id`, `first_name`, `last_name`, `contact_no`, `title`, `description`, `qualification`, `account_name`, `bank_name`, `branch_name`, `account_no`, `verification`, `isActive`, `applied_date`) VALUES
('28', 2, 'prasad', 'lakshan', '', '', 'good', 'science', 'prasad', 'sampath', 'matara', '1110011000', 'verified', 1, ''),
('29', 3, 'lakshan', 'prasad', '', '', 'good', 'maths', 'lakshan', 'peoples', 'galle', '122221909', 'verified', 1, ''),
('1', 4, 'sadeepa', 'bhashitha', '', '', 'ddddd', 'none', 'bhashitha', 'sampath', 'matara', '11121', 'verified', 0, ''),
('auth0|62eb5585216efec017deb44d', 5, 'asd', 'asd', '0987654321', '', 'ss', 'none', 'sad', 'asd', 'asd', 'asd', 'verified', 1, ''),
('auth0|62eb5635c638d3ae640a6b98', 6, 'Rathapriya', 'Saman', '0987654321', '', 'Weel', 'none', 'Saman', 'Sampath', 'Galle', '1234', 'verified', 1, ''),
('auth0|62eba8ef216efec017debaaf', 7, 'Prasa', 'Kpd', '0987654321', '', 'Clever', 'none', 'Prasa', 'BOC', 'Galle', '1234', 'verified', 1, 'Thu Aug 04 2022'),
('auth0|62eba9b1216efec017debabe', 8, 'shaki', 'balhasan', '0987654321', '', 'sss', 'none', 'dsad', 'asdas', 'asd', 'ss', 'rejected', 1, '2022-08-04'),
('auth0|62ef3fe45c78b441451857ca', 1000010223, 'Upulshantha', 'Sanasgala', '0987654321', '', 'Good', 'none', 'Sanasgala', 'Samapath', 'Galle', '1234', 'verified', 1, '2022-08-07'),
('auth0|62f33a72304686da7831a5ac', 1000010224, 'Nirmal', 'Ilanagama', '077-2345678', '', 'I\'m having more than 7 years of experience in teaching at a renowned government school as a Mathematics teacher My students were able to produce great results in the examinations.', 'none', 'L.L.U. Nirmal Illanagama', 'Peoples Bank', 'Kaluthara', '90842345', 'pending', 1, '2022-08-10');
...
INSERT INTO `teacher_class` (`class_id`, `course_id`, `teacher_id`, `date`, `start_time`, `end_time`, `isActive`, `isStarted`) VALUES
(1996, 3, 2, '2022-08-02 18:30:00', '18:30', '21:30', 1, 0),
(1997, 4, 3, '2022-07-10 18:30:00', '16:00', '18:00', 1, 0),
(1998, 23, 1000010224, '2022-08-29 18:30:00', '15:30', '18:30', 1, 0),
(1999, 100, 1000010223, '2022-08-30 18:30:00', '15:30', '17:30', 1, 0),
(2000, 3, 2, '2022-08-09 18:30:00', '18:30', '21:30', 1, 0),
(2001, 4, 3, '2022-07-17 18:30:00', '16:00', '18:00', 1, 0),
(2002, 23, 1000010224, '2022-09-05 18:30:00', '15:30', '18:30', 1, 0),
(2003, 100, 1000010223, '2022-09-06 18:30:00', '15:30', '17:30', 1, 0);
...
ALTER TABLE `teacher_class`
  ADD PRIMARY KEY (`class_id`),
  ADD KEY `FK TO COURSE FROM TEACHER_CLASS` (`course_id`),
  ADD KEY `FK TO TEACHER FROM TEACHER_CLASS` (`teacher_id`);
...
--
ALTER TABLE `teacher_class`
  MODIFY `class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2004;
...
--
ALTER TABLE `teacher_class`
  ADD CONSTRAINT `FK TO COURSE FROM TEACHER_CLASS` FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK TO TEACHER FROM TEACHER_CLASS` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_id`) ON DELETE CASCADE ON UPDATE CASCADE;
