...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2022 at 08:36 AM
...
(1, 3, '2022-07-26', 'http://localhost/phpmyadmin/index.php?route=/table/change&db=groupproject2&table=parent_payment', 1),
(2, 4, '2022-07-26', 'http://localhost/phpmyadmin/index.php?route=/table/change&db=groupproject2&table=parent_payment', 1);
...
(1, '2022-07-26', 'http://localhost/phpmyadmin/index.php?route=/table/change&db=groupproject2&table=parent_payment', 3, 1),
(2, '2022-07-26', 'http://localhost/phpmyadmin/index.php?route=/table/change&db=groupproject2&table=parent_payment', 4, 1);
