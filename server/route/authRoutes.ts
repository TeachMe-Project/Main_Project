...
import {
    ...
    createAuthParent,
    createAuthStudent,
    createAuthTeacher, printRequest, unBlockAuthUser, changeUserDetails, changeImage
} from '../auth0_api/user';
...
authRouter.route('/changeProfile').post(changeUserDetails);
authRouter.route('/changeImage').post(changeImage);
