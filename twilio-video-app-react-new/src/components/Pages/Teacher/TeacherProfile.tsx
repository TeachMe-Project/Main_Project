...
const TeacherProfile = () => {
    const {user} = useAuth0(), teacherAuthId = user?.sub;
                    ...
                    <Row className="pb-md-0">
                      <Form noValidate onSubmit={handleSubmit}>
                        <Tabs defaultActiveKey="profile" id="uncontrolled-tab-example" className="mb-3 tabs ">
                          <Tab eventKey="profile" title="Profile Details" style={{ fontWeight: 700 }}>
                            <Row className="mt-lg-0 me-3 mt-md-3 d-flex flex-row">
                              <Col lg={6} md={6} sm={12} xs={12}>
                                <Form.Group
                                  className="mb-2 ProfileDetailsContainer"
                              ...
                              <Col lg={6} md={12} sm={12} xs={12}>
                                <Form.Group className="mb-2" controlId="validationMobile">
                                  ...
                                  <Form.Control
                                    ...
                                    onChange={handleChange}
                                    isInvalid={
                                      !!errors.Mobile ? changeMobileValidate(false) : changeMobileValidate(true)
                                    }
                              ...
                              <Col lg={10} md={12} sm={12} xs={12}>
                                <Form.Group className="mb-2" controlId="validationAccountNo">
                                  ...
                                  <Form.Control
                                    ...
                                    isInvalid={
                                      !!errors.AccountNo
                                        ? changeAccountNoValidate(false)
                                        : changeAccountNoValidate(true)
                                    }
                          ...
                          {/*     className="teacherprofiletabcontent Qualification">*/}
                          ...
                          {/*                                <FiDownload*/}
                          {/*                                    className="ReactIcon DownloadBtn"/>*/}
                          {/*                            </Link>*/}
                          {/*                        </button>*/}
                          {/*                    </div>*/}
                          {/*                </Col>*/}
