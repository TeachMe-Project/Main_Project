...
const NewChatPopup = () => {
      ...
      return (
        <div className="newChatPopup">
          ...
          <div className="content">
            ...
            amet dignissimos? <br /> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur sit commodi
            beatae optio voluptatum sed eius cumque, delectus saepe repudiandae explicabo nemo nam libero ad, doloribus,
  ...
  return (
    <div>
      <button className="addChat" onClick={togglePopup}>
        <AiOutlinePlus />
      </button>
      {/* <div className='newChatPopup'>
                <div className="header"> Modal Title </div>
